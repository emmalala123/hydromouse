...
#include "include/AccelStepper/src/AccelStepper.h" //ManageLibraries > AccelStepper
...
void loop() { 
 ...
 //Serial.print(int(clock1.getMinute()));
  if(int(clock1.getHour(h12Flag, pmFlag)) == 13 && int(clock1.getMinute())== 40){
     runStepper(23);
  }
  if(int(clock1.getMinute())== 41){
    runStepper(-20);
  }
